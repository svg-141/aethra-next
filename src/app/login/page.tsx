      ...
      <main className="relative z-10 min-h-[80vh] flex flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10 animate__animated animate__fadeInDown">
            <h1 className="text-5xl font-extrabold text-theme-primary mb-2 glow-text">AETHRA</h1>
            <p className="text-lg text-theme-secondary opacity-90">Domina el meta con inteligencia artificial</p>
          </div>
          {/* Tarjeta de login */}
          <div className="theme-card p-8 animate__animated animate__fadeIn backdrop-blur-md">
            <h2 className="text-2xl font-bold text-theme-primary text-center mb-6">Iniciar Sesión</h2>
            {/* Formulario */}
            <form className="space-y-6" onSubmit={handleSubmit}>
              {/* Email */}
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-theme-secondary mb-1 opacity-90">Correo Electrónico</label>
                <div className="relative">
                  ...
                  <input
                    className="theme-input block w-full pl-10 pr-3 py-3 rounded-lg focus:outline-none transition-all"
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <label htmlFor="password" className="block text-sm font-medium text-theme-secondary opacity-90">Contraseña</label>
                  <a href="#" className="text-xs text-theme-primary hover:text-theme-primary-light transition-colors">¿Olvidaste tu contraseña?</a>
                </div>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-purple-400 opacity-90" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-theme-secondary opacity-90">Recordar mi sesión</label>
              </div>
              {/* Botón de login */}
              <div>
                <button
            ...
            {/* Login social */}
              <div>
                <a href="#" className="theme-button-secondary w-full inline-flex justify-center items-center py-2 px-4 border rounded-lg text-sm font-medium transition-all">
                  <svg className="w-5 h-5 mr-2 text-theme-primary" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <footer className="relative z-10 py-6 px-4 border-t theme-border">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-theme-secondary text-center md:text-left opacity-80">
              &copy; 2025 Aethra. Todos los derechos reservados.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              <a href="#" className="text-theme-secondary hover:text-white transition-colors">
