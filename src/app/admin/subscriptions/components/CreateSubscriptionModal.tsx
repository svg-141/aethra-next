...
import { createSubscription } from '../../../../../backend/services/subscriptionService';
...
export default function CreateSubscriptionModal({ onClose, onSubscriptionCreated }: CreateSubscriptionModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    onSubscriptionCreated({ id: subscriptionId, ...subscriptionData });
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div className="theme-bg-surface p-8 rounded-lg">
        <h2 className="text-2xl font-bold theme-text-primary mb-6">Crear Suscripción</h2>
